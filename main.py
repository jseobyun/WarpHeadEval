...
def parse_config():
    ...
    parser.add_argument("--exp_name", default="faceverse_ours")
...
if __name__ == "__main__":
    ...
    for index in tqdm(range(num_predictions)):
        ...
        gt2pred["face_uvcount"] = face_count
        gt2pred["nonface_uvcount"] = nonface_count
        gt2pred["all_uvcount"] = all_count
        gt2pred["uv_threshold"] = thresholds.tolist()
