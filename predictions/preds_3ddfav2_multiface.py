...
class Preds3DDFAv2Multiface():
    def __init__(self, root):
        self.root = root

        verts53215_uvs = np.load(os.path.join(curr_dir, "../assets/bfm_verts_uvs53215.npy"))
        map53215to38365 = np.load(os.path.join(curr_dir, "../assets/bfm_vidx53215to38365.npy"))
        self.verts38365_uvs = verts53215_uvs[map53215to38365]
        ...
        self.triangles_uvs = np.load(os.path.join(curr_dir, "../assets/bfm38365_uvs_per_face.npy"))
        ...
        self.kp_idx = np.load(os.path.join(curr_dir, "../assets/bfm_kidx38365.npy")).reshape(-1)
    ...
    def gather_paths(self):
        ...
        print(f"Multifiace predictions of 3DDFAV2 is ready : {len(pred_dirs)}")
    ...
    def __call__(self, sample_id):
        ...
        mesh_path = os.path.join(self.pred_dirs[index], f"{subj_id}.ply")
