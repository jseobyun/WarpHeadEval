...
class PredsEMOCAFaceverse():
    def __init__(self, root="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/evals/EMOCA/faceverse_results"):
        self.root = root
    ...
    def gather_paths(self):
        ...
        print(f"Faceverse predictions of EMOCA is ready : {len(pred_dirs)}")
