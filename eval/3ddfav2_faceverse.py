...
from predictions.preds_3ddfav2_faceverse import Preds3DDFAv2FaceVerse


def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="faceverse_3ddfav2")
    parser.add_argument("--benchmark_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/datasets/faceverse_benchmark")
    parser.add_argument("--prediction_root", default="/media/jseob/Extreme SSD/3DDFAV2/faverse_results")
...
if __name__ == "__main__":
    ...
    dfa3dv2 = Preds3DDFAv2FaceVerse(args.prediction_root)
    ...
    for index in tqdm(range(num_samples)):
        ...
        o3d_mesh, kps_pred, pred_id = dfa3dv2(sample_id)
        ...
        if pred_id is None:
            ...
            points_gt = backproject_depth(K, d_gt) * scale_factor
            points_pred = backproject_depth(K, d_pred) * scale_factor


            if args.vis:
                points_vis = points_gt.copy().reshape(-1, 3) / scale_factor
