...
from predictions.preds_hrn_faceverse import PredsHRNFaceVerse

def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="faceverse_hrn")
    parser.add_argument("--benchmark_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/datasets/faceverse_benchmark")
    parser.add_argument("--prediction_root", default="/media/jseob/Extreme SSD/faceverse_results/HRN")
...
if __name__ == "__main__":
    ...
    hrn = PredsHRNFaceVerse(args.prediction_root)
