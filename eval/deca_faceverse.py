...
from predictions.preds_deca_faceverse import PredsDECAFaceverse
from pytorch3d.ops import knn_points, knn_gather

def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="faceverse_deca")
...
if __name__ == "__main__":
    ...
    args = parse_config()
    faceverse = FaceVerseBenchmark(split = args.split)
    deca = PredsDECAFaceverse()
    ...
    for index in tqdm(range(num_samples)):
        ...
        o3d_mesh, kps_pred, pred_id = deca(sample_id)
