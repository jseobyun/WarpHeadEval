...
from predictions.preds_prnet_multiface import PredsPRNetMultiface

def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="multiface_prnet")
    parser.add_argument("--benchmark_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/datasets/multiface_benchmark")
    parser.add_argument("--prediction_root", default="/media/jseob/X9/eval/prnet/multiface")
...
if __name__ == "__main__":
    ...
    prnet = PredsPRNetMultiface(args.prediction_root)
    ...
    for index in tqdm(range(num_samples)):
        ...
        o3d_mesh, kps_pred, pred_id = prnet(sample_id)
