...
from predictions.preds_ours_multiface import PredsOursMultiface
from pytorch3d.ops import knn_points, knn_gather

def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="multiface_ours")
...
if __name__ == "__main__":
    ...
    ours = PredsOursMultiface(root=os.path.join("/media/jseob/db974b7f-3790-49e0-acf4-e8511d26cde9/evals/predictions", args.exp_name))
    ...
    for index in tqdm(range(num_predictions)):
        ...
        scale_factor = 0.02 / eye_dist
        print(eye_dist, scale_factor)
        ...
        if args.vis:
            pcd_pred = make_pcd(points_pred[mask])
            pcd_gt = make_pcd(points_gt[mask])
