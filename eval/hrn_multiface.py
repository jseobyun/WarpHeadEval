...
from predictions.preds_hrn_multiface import PredsHRNMultiface

def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="multiface_hrn")
    parser.add_argument("--benchmark_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/datasets/multiface_benchmark")
    parser.add_argument("--prediction_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/evals/HRN/multiface_results")
...
if __name__ == "__main__":
    ...
    args = parse_config()
    multiface = MultiFaceBenchmark(args.benchmark_root)
    hrn = PredsHRNMultiface(args.prediction_root)
    ...
    for index in tqdm(range(num_samples)):
        ...
        o3d_mesh, kps_pred, pred_id = hrn(sample_id)
