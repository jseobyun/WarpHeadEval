...
from predictions.preds_3ddfav3_multiface import Preds3DDFAv3Multiface

def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="multiface_3ddfav3")
    parser.add_argument("--benchmark_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/datasets/multiface_benchmark")
    parser.add_argument("--prediction_root", default="/media/jseob/X9/eval/3ddfa-v3/multiface")
...
if __name__ == "__main__":
    ...
    dfa3dv3 = Preds3DDFAv3Multiface(args.prediction_root)
    ...
    for index in tqdm(range(num_samples)):
        ...
        o3d_mesh, kps_pred, pred_id = dfa3dv3(sample_id)
