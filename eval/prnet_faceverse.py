...
from predictions.preds_prnet_faceverse import PredsPRNetFaceVerse


def parse_config():
    parser = argparse.ArgumentParser()
    parser.add_argument("--exp_name", default="faceverse_prnet")
    parser.add_argument("--benchmark_root", default="/media/jseob/7c338ab7-a4a5-460a-a3bb-6c26309b51ba/datasets/faceverse_benchmark")
    parser.add_argument("--prediction_root", default="/media/jseob/X9/eval/prnet/faceverse")
...
if __name__ == "__main__":
    ...
    prnet = PredsPRNetFaceVerse(args.prediction_root)
